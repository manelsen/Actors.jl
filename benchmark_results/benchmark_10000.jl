...
println("=== 10000 SAMPLE BENCHMARK ===")
println("")

println("Benchmarking spawn (no args) [10000 samples]...")
b_spawn = @benchmark begin
    lk = spawn(echo)
    exit!(lk)
end samples=10000 evals=1
results["spawn_no_args"] = median(b_spawn).time / 1000

println("Benchmarking single request [10000 samples]...")
...
println("Benchmarking ping_pong_1 [10000 samples]...")
...
println("Benchmarking ping_pong_100 [200 samples]...")
...
println("Benchmarking sequential_100 [200 samples]...")
...
println("Benchmarking cast_100 [200 samples]...")
...
println("Benchmarking cast_1000 [100 samples]...")
